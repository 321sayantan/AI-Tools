      ...
      <div id="feature-section" className=" back features text-start ">
        ...
        <main>
          ...
          <div className="container px-4 py-5">
            <h2 className="pb-2 text-center display-5 fw-bold">
              Elevate Your Productivity with AI Tools
            </h2>
            <div className="row row-cols-1 row-cols-md-2 align-items-md-center g-5 py-5">
              <div className="col d-flex flex-column align-items-start gap-2">
                <h2 className="fw-bold">AI-Powered Tools for Productivity</h2>
                <p className="">
              ...
              <div className="col">
                <div className="row row-cols-1 row-cols-sm-2 g-4">
                  ...
                  <div className="col d-flex flex-column gap-2">
                    ...
                    <p className="">Generate images from prompts with ease.</p>
                  </div>
                  <div className="col d-flex flex-column gap-2">
                    <div className="feature-icon-small d-inline-flex align-items-center justify-content-center text-bg-primary bg-gradient fs-4 rounded-3">
                      <svg className="bi" width="1em" height="1em">
                    ...
                    <p className="">Get quick, clear summaries of any text.</p>
                  </div>
                  <div className="col d-flex flex-column gap-2">
                    <div className="feature-icon-small d-inline-flex align-items-center justify-content-center text-bg-primary bg-gradient fs-4 rounded-3">
                      <svg className="bi" width="1em" height="1em">
                    ...
                    <p className="">
                      Convert prompts into JavaScript code instantly for faster
                      development.
                    </p>
                  </div>
                </div>
